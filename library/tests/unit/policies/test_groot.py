...
class TestNNPrimitives:
    ...
    def test_swish_activation(self) -> None:
        ...
        from physicalai.policies.shared.components.nn import swish
    ...
    def test_category_specific_linear(self) -> None:
        ...
        from physicalai.policies.shared.components.nn import CategorySpecificLinear
    ...
    def test_multi_embodiment_action_encoder(self) -> None:
        ...
        from physicalai.policies.shared.components.nn import MultiEmbodimentActionEncoder
